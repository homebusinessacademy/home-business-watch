    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Breakage refers to commissions generated by downline purchases that are never paid out to the upline because the upline failed to meet a qualification requirement. Some companies design their comp plans with complex qualification thresholds — rank requirements, leg requirements, active customer minimums — that create predictable breakage. When you fall short of a threshold by even one requirement, those commissions do not disappear — they flow back to the company as additional profit.',
        },
      },
      {
        '@type': 'Question',
