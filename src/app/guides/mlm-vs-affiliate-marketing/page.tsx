            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 mb-6">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-700"><strong><Link href="/companies/doterra" className="text-amber-600 hover:underline">doTERRA</Link>:</strong> requires 100 PV/month (~$100-150 in purchases) just to qualify for commissions — most participants spend more than they earn</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-5 h-5 text-red-500 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clipRule="evenodd" />
