...
export const extendedCompanies: Company[] = [
  ...
  },
  {
    ...
    value_rating: 4.0,
    pros: [
      '10 years in business — B2B SaaS focus',
      'Per-customer residual ~$10-50/mo (20-50% recurring)',
      'Top SaaS brands: Notion, Freshbooks, Webflow',
      'Free for publishers',
  ...
  },
  {
    ...
    value_rating: 4.5,
    pros: [
      '21 years in business — premium ad network',
      'Residual from traffic (~$15-40 per 1K visits)',
      '75% revenue share — 2-4x AdSense RPMs',
  ...
  },
  {
    ...
    value_rating: 3.0,
    pros: [
      '27 years in business — P90X, Insanity brand',
      'Per-customer residual ~$5-10/mo on BODi subs',
      'Pivoted to single-level affiliate Nov 2024',
      'Real fitness products with demand'
    ],
    cons: [
  ...
  },
  {
    ...
    value_rating: 3.0,
    pros: [
      '10 years in business — Idaho Falls',
      'Per-purchase commission (one-time metals)',
      'Pivoted MLM → affiliate March 2026',
      'Real tangible assets (gold/silver)'
    ],
    cons: [
  ...
  },
  {
    ...
    value_rating: 4.0,
    pros: [
      '21 years in business — Ottawa',
      'CPA only (one-time per action)',
      'Weekly payments',
  ...
  },
  {
    ...
    category: 'high_risk',
    founded_year: 2019,
    hq_location: 'Singapore (Lootbox International)',
    website: 'super.one',
    products_summary: 'SuperOne is a blockchain-based trivia and sports entertainment app where users play sports and entertainment trivia in a "Battle Royale" format. The platform involves "Lootbox" token purchases and affiliate recruitment. BehindMLM has documented three separate relaunch cycles (2020, 2022, 2025), with each review noting participant withdrawal issues following the previous version. The company is registered in Singapore as Lootbox International and led by CEO Andreas Christensen.',
    monthly_cost_min: 0,
    monthly_cost_max: 500,
    comp_plan_type: 'Token-based with affiliate recruitment',
    overall_rating: 1.0,
    residual_rating: 1.0,
    simplicity_rating: 1.5,
    transparency_rating: 1.0,
    ...
    pros: [
      ...
      'Trivia gameplay concept is entertaining',
      'Available on iOS and Android app stores',
    ],
    cons: [
      'BehindMLM has documented three relaunch cycles since 2019',
      'Previous participants have reported withdrawal difficulties',
      'Compensation structure not fully transparent to consumers',
      'Passive income model tied to new participant activity',
      'Registered offshore in Singapore — limits legal recourse',
      'No regulatory approval documented in major jurisdictions',
    ],
    quick_facts: {
      'Founded': '2019',
      'Headquarters': 'Singapore (Lootbox International)',
      'CEO': 'Andreas Christensen',
      'Business Model': 'Token-based trivia + affiliate recruitment',
      'BehindMLM Reviews': '3 (2020, 2022, 2025)',
    ...
    tagline: 'Multiple BehindMLM Reviews — Exercise Caution',
    faq: [
      {
        question: 'What concerns have been raised about SuperOne?',
        answer: 'BehindMLM has reviewed SuperOne three times (2020, 2022, 2025), documenting relaunch cycles and participant withdrawal concerns. The passive income model appears tied to new participant activity rather than external revenue. The company is registered offshore in Singapore.',
      },
      {
        question: 'Who is behind SuperOne?',
        answer: 'SuperOne is led by CEO Andreas Christensen and registered in Singapore as Lootbox International.',
      },
      {
        question: 'Is the SuperOne trivia app real?',
        answer: 'Yes, the trivia app is functional and available on iOS and Android. It runs sports and entertainment trivia in a Battle Royale format. The concerns raised by third parties relate to the compensation structure, not the app itself.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    category: 'mlm',
    founded_year: 2013,
    hq_location: 'Fort Lauderdale, Florida, USA',
    website: 'mwrlife.com',
    products_summary: 'MWR Life is a travel membership club offering "Travel Advantage" — wholesale pricing on hotels (30-80% off claimed), cruises, resorts, car rentals, and activities. Members pay $99/year as Lifestyle Ambassador + monthly membership ($119.97/mo for Elite tier with $120 activation). The company claims 500,000+ members globally and operates from offices in Florida, Hong Kong, France, and Dubai. Representatives earn ~$10/month per customer residual plus up to $50 bonus per service enrolled. Founded in 2013 (originally as My Warranty Rewards), the company has 4.8★ on Trustpilot (1,330 reviews). BBB inquiries in 2022 and 2025 addressed misleading earnings claims by salesforce members. Russia\'s Central Bank issued a pyramid scheme warning in September 2025.',
    monthly_cost_min: 120,
    monthly_cost_max: 240,
    comp_plan_type: 'Binary MLM — customer bonuses up to $50 + ~$10/mo residual + team bonuses',
    overall_rating: 2.3,
    residual_rating: 2.3,
    simplicity_rating: 2.0,
    transparency_rating: 3.0,
    ...
    pros: [
      ...
      'Real travel savings with 4.8★ Trustpilot rating',
      'Per-customer residual ~$10/mo',
      'Operates in 60+ countries with real offices'
    ],
    cons: [
      'Low per-customer residual (~$10/mo)',
      'Russia Central Bank pyramid warning (2025)',
      'BBB inquiries on misleading earnings claims',
      'Multiple company name changes since 2013'
    ],
    quick_facts: {
      'Founded': '2013',
      'Headquarters': 'Fort Lauderdale, FL (also Hong Kong, France, Dubai)',
      'Membership Cost': '$99/year Ambassador + $119.97/mo Elite',
    ...
    faq: [
      {
        ...
        answer: 'MWR Life is not technically a pyramid scheme — it sells real travel memberships with documented savings. However, Russia\'s Central Bank issued a pyramid scheme warning in September 2025, and the BBB has inquired about misleading earnings claims by salesforce members (2022, 2025). The company sells genuine travel services but income requires significant recruitment.',
      },
      {
        question: 'Is MWR Life legit?',
        answer: 'MWR Life is a legal MLM travel club operating since 2013 with offices in four countries. The travel savings are real (members report 30-80% off bookings) and the company has strong Trustpilot reviews (4.8★). As with all MLMs, income depends heavily on recruiting — the per-customer residual is ~$10/month.',
      },
      {
        question: 'How much does MWR Life cost?',
        answer: 'To become a Lifestyle Ambassador: $99/year. Travel Advantage Elite membership: $120 activation + $119.97/month. Total first year cost as an Elite member: ~$1,560. Plus membership costs for lower tiers available.',
      },
      {
        question: 'What is MWR Life vs MWR Financial?',
        answer: 'MWR Life focuses on travel savings via Travel Advantage memberships. MWR Financial is a separate company (same founder) focused on financial wellness tools. They operate independently but share MLM structure heritage.',
      },
    ],
  },
  {
