...
export const companiesBatch1: Company[] = [
  {
    ...
    value_rating: 3.0,
    pros: [
      '41 years in business — public company (NYSE: NUS)',
      'Per-customer residual ~$6-8/mo on subscriptions',
      'ageLOC anti-aging line with research backing',
      '$1.73B revenue (2024) — established scale'
    ],
    cons: [
      'Low per-customer residual (~$6-8/mo)',
      '$47M FTC settlement (1997)',
      'Complex Stairstep Breakaway plan',
      'Revenue declining 12% (2024)'
    ],
    quick_facts: {
      'Founded': '1984',
  ...
  },
  {
    ...
    value_rating: 3.5,
    pros: [
      '48 years in business — public company (NYSE: PRI)',
      'Per-customer residual ~$15-20/mo on policy renewals',
      'Legitimate regulated financial products',
      '$3.09B revenue (2024) up 12.4%'
    ],
    cons: [
      'Per-customer residual moderate (~$15-20/mo)',
      '$99 + $100-300 licensing costs upfront',
      'Productivity only 0.20 policies/rep/month',
      'Products often pricier than independents'
    ],
    quick_facts: {
      'Founded': '1977',
  ...
  },
  {
    ...
    value_rating: 3.5,
    pros: [
      '62 years in business — iconic brand recognition',
      'Per-customer residual ~$25/mo on subscriptions',
      '50% profit potential on retail',
      'Strong community culture'
    ],
    cons: [
      'Per-customer residual moderate (~$25/mo)',
      '88% of consultants earn no commissions',
  ...
  },
  {
    ...
    value_rating: 2.5,
    pros: [
      '17 years in business — strong brand recognition',
      'Per-customer residual ~$6/mo on subscriptions',
      'CPTG quality testing standard',
      'Passionate wellness community'
    ],
    cons: [
      'Low per-customer residual (~$6/mo)',
      '100 PV monthly (~$150-200) to earn',
      'FTC warning letter (2019)',
      '<1% chance of $860+/year',
  ...
  },
  {
    ...
    value_rating: 2.5,
    pros: [
      '32 years in business — pioneer of essential oils MLM',
      'Per-customer residual ~$4-5/mo on subscriptions',
      'Seed to Seal quality + owns farms',
      'Strong brand loyalty'
    ],
    cons: [
      'Very low per-customer residual (~$4-5/mo)',
      'FTC warning (2020) COVID claims',
      '100 PV (~$100-150/mo) to earn',
      '89% earn avg $4/year'
    ],
    quick_facts: {
      'Founded': '1993',
  ...
  },
  {
    ...
    value_rating: 3.0,
    pros: [
      '45 years in business — vegan/cruelty-free',
      'Per-customer residual ~$12/mo on subscriptions',
      'B Corp certified clean standards',
      'Strong consultant community'
    ],
    cons: [
      'Per-customer residual moderate (~$12/mo)',
      '$100 PRV monthly for commissions',
      'Chapter 11 in 2009 (restructured)',
      'Median earnings $77/year (2023)'
    ],
    quick_facts: {
      'Founded': '1980',
  ...
  },
  {
    ...
    value_rating: 2.0,
    pros: [
      '11 years in business — strong social media',
      'Per-customer residual ~$15/mo on subscriptions',
      'Trendy haircare niche',
      'Active community'
    ],
    cons: [
      'Per-customer residual low-moderate (~$15/mo)',
      '$17.4M hair loss settlement (2021)',
      '41% earned $0 in 2024',
      'FL AG ongoing scrutiny'
    ],
    quick_facts: {
      'Founded': '2014',
  ...
  },
  {
    ...
    pros: [
      ...
      'System-based 30-day cleanse approach',
      'Strong community culture'
    ],
    cons: [
      'Per-customer residual moderate (~$11/mo)',
      'Monthly $150-400+ requirements',
      'Company admits most won\'t succeed',
      'Binary plan complex'
    ],
    quick_facts: {
      'Founded': '2002',
  ...
  },
  {
    ...
    value_rating: 4.0,
    pros: [
      '23 years — switched to affiliate model (Sept 2024)',
      'Per-customer residual ~$15/mo (30% flat)',
      'No rank maintenance — simple affiliate',
      'Dermatologist-founded (Proactiv creators)'
    ],
    cons: [
      'Per-customer residual moderate (~$15/mo)',
      'Major model change — stability uncertain',
      'Not accepting new consultants',
      'Premium pricing'
    ],
    quick_facts: {
      'Founded': '2002',
  ...
  },
  {
    ...
    value_rating: 1.5,
    pros: [
      '13 years in business — still operating',
      'Per-customer residual ~$2-5 (one-time sales)',
      '2024 avg gross $11,914 (median: $1,046)',
      'Flexible online/home party model'
    ],
    cons: [
      'Minimal residual (one-time sales)',
      '$4.75M WA pyramid scheme settlement',
      '"LuLaRich" documentary exposed practices',
      'Peak 80,000+ collapsed'
    ],
    quick_facts: {
      'Founded': '2012',
  ...
  },
  {
    ...
    value_rating: 3.5,
    pros: [
      '17 years in business — popular Pink Drink',
      'Per-customer residual ~$12/mo on subscriptions',
      'Low $19.95 startup cost',
      'Growing gut health trend'
    ],
    cons: [
      'Per-customer residual moderate (~$12/mo)',
      'FTC warning letters for health claims',
      'Monthly autoship to earn',
      'Avg earnings $742/year (2024)'
    ],
    quick_facts: {
      'Founded': '2008',
  ...
  },
  {
    ...
    value_rating: 4.0,
    pros: [
      '33 years in business — public (NYSE: USNA)',
      'Per-customer residual ~$9/mo on subscriptions',
      'NSF Certified for Sport — pharma-grade',
      '$855M revenue (2024)'
    ],
    cons: [
      'Low per-customer residual (~$9/mo)',
      '34% "earned less than $0" (lost money)',
      'Binary plan — 72% to top 2.31%',
      'Revenue declining ($921M → $855M)'
    ],
    quick_facts: {
      'Founded': '1992',
  ...
  },
  {
    ...
    value_rating: 3.0,
    pros: [
      '27 years in business — patented Transfer Factor',
      'Per-customer residual ~$8-12/mo on subscriptions',
      '$300M revenue (2024) — 70+ countries',
      '35% commission payout'
    ],
    cons: [
      'Low per-customer residual (~$8-12/mo)',
      '~80% earn nothing',
      'Binary plan requires balanced legs',
      '$100-300/mo autoship to qualify'
    ],
    quick_facts: {
      'Founded': '1998',
