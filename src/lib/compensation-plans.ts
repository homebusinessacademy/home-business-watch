...
export const compPlans: CompPlanData[] = [
  ...
  },
  {
    ...
    levels: [
      ...
      { level: 3, label: 'Building Bonus (16 blocks)', residualPerCustomer: null, notes: 'Up to 40% at 16 blocks' },
      { level: 4, label: 'Leading Bonus', residualPerCustomer: null, notes: 'Requires Brand Representative rank' },
    ],
    monthlyRequirement: '100 PSV (~$100/month)',
    qualificationNote: 'Sharing Bonus ranges 5-15% (paid daily). Building Bonus ranges 5-40% based on completing 500-point blocks (16 blocks = 40%). Per-customer residual set to null because it varies heavily by block completion. New Sales Performance Plan effective November 2024.',
    simpleSummary: 'Nu Skin pays 5-15% Sharing Bonus on customer orders (daily) plus Building Bonus (5-40%) based on completing 500-point team sales blocks. Company paid $122M in sales compensation to US Brand Affiliates in 2024.',
    teamSizeNeeded: {
      goal1000: 133,
      goal3000: 400,
      goal10000: 1333,
      assumptions: 'Based on $7.50 avg per customer at 15% Sharing Bonus. Building bonuses require completing 500-point blocks.',
    },
    sourceUrl: 'https://www.nuskin.com/content/dam/global/library/Oct2024/2024-nu-skin-sales-performance-plan.pdf',
    keyGotchas: [
      'Only 24.67% of Brand Affiliates were "Active" in 2024',
      'Average monthly earnings for Active affiliates: $178.35 (2024)',
      'Building Bonus typical: $273/month (all Brand Reps), $467 at 2,000+ GSV',
      'New Sales Performance Plan launched November 2024',
  ...
  },
  {
    ...
    qualificationNote: 'January 2025 restructure: Commission now variable per-campaign based on total Campaign Sales volume, not annual totals. Rates scale up to 50% per 2-week cycle. Per-customer residual is null because rate varies by campaign volume.',
    simpleSummary: 'Avon restructured in January 2025 with variable per-campaign commissions up to 50%. Commission starts when orders reach $40+ per campaign and increases with campaign sales volume. Replaces the old annual sales-tier model.',
    teamSizeNeeded: {
      goal1000: 80,
      goal3000: 240,
      goal10000: 667,
      assumptions: 'Based on $12.50 per $50 customer order at 25%. New variable system can pay higher with volume.',
    },
    sourceUrl: 'https://www.avon.com/magnoliaPublic/dam/pdf/2025/guides/avon-2025-career-and-compensation-guide-en.pdf',
    keyGotchas: [
  ...
  },
  {
    ...
    levels: [
      ...
      { level: 3, label: 'District Leader', residualPerCustomer: null, notes: '50% personal + 15% override on Sr Reps + 25% on Reps' },
      { level: 4, label: 'Division Leader', residualPerCustomer: null, notes: '60% personal + overrides on all levels' },
    ],
    monthlyRequirement: 'Active insurance license required',
    qualificationNote: 'Commission-based insurance/financial services. Reps earn 25% on life insurance sales, scaling to 60% at Division Leader. Residual income from policy renewals and investment products. No fixed per-customer residual.',
    ...
    teamSizeNeeded: {
      ...
      goal3000: null,
      goal10000: null,
      assumptions: 'Commission-based insurance sales. No fixed per-customer residual. Average rep earned $8,199 (Jan-Dec 2025).',
    },
    ...
    keyGotchas: [
      ...
      'Commission scales: 25% (Rep) → 35% (Sr Rep) → 50% (District) → 60% (Division)',
    ],
  },
  {
  ...
  },
  {
    ...
    levels: [
      ...
      { level: 3, label: 'Matching bonus', residualPerCustomer: null, notes: 'Up to 15% lifetime on sponsored associates' },
      { level: 4, label: 'Fast Start (Oct 2025+)', residualPerCustomer: null, notes: '10% bonus on first 6 months of purchases' },
    ],
    monthlyRequirement: '100 PSV per Rolling 4-Week Period',
    qualificationNote: 'Binary plan pays 20% of the lesser leg SVP weekly (min 125 SVP). Example: 300 SVP left leg + 700 SVP right leg = 20% of 300 = $60. Per-customer residual is null due to binary complexity. New October 2025 plan adds 10% Fast Start.',
  ...
  },
  {
    ...
    qualificationNote: 'Inventory-based model. Retailers buy clothing wholesale and sell at markup. 2024 average retail gross profit: $10,897 (median: $1,046). No fixed per-customer residual as profit depends on markup achieved.',
    ...
    keyGotchas: [
      ...
      '2024 avg gross profit: $10,897 but median only $1,046 (heavily skewed)',
      'Only 9.63% participated in Leadership Compensation Plan in 2024',
      'Expenses can be hundreds to thousands of dollars annually',
  ...
  },
  {
    ...
    levels: [
      ...
      { level: 3, label: '$500+ PV tier', residualPerCustomer: 12.50, notes: '25% on $50 order' },
      { level: 4, label: 'BBB (new VIP orders)', residualPerCustomer: 10, notes: '20% Business Building Bonus on 100+ PV initial orders' },
    ],
    monthlyRequirement: '100 PV + Plexus Annual Membership (PAM)',
    qualificationNote: 'Commission rate scales with monthly PV: 0% (under 100), 15% (100-499), 25% (500+). Commission earned on PV exceeding 100. 50% of company CV paid to Ambassadors; 5% goes to Jewel pools. Per-customer is null due to tiered rates.',
    simpleSummary: 'Plexus pays 0-25% retail commission based on monthly PV tier. You must hit 100 PV to earn anything, then earn on volume above 100 PV. Business Building Bonus pays 20% on new VIP customer first 100+ PV orders. 2024 average active earnings: $2,952.',
    teamSizeNeeded: {
      goal1000: 80,
      goal3000: 240,
      goal10000: 800,
      assumptions: 'Based on $12.50 per customer at 25% rate ($500+ PV tier). Lower tiers earn significantly less.',
    },
    ...
    keyGotchas: [
      ...
      'Plexus Annual Membership (PAM) fee required to remain qualified',
    ],
  },
  {
    ...
    levels: [
      ...
      { level: 3, label: 'Manager (team commissions)', residualPerCustomer: null, notes: '18% on Manager volume + overrides' },
    ...
    qualificationNote: 'Preferred Customers get 5% discount; Wholesale Qualified (2CC in 2 months) gets 30%. Managers earn 18% on Manager volume + overrides (5-13% depending on downline rank). Per-customer is null because it varies by discount level.',
    simpleSummary: 'Forever Living pays 5-30% based on discount level. Preferred Customers earn 5%; Wholesale Qualified earns 30%. Managers earn 18% on volume + 5-13% overrides. Leadership Bonus: 6%/3%/2% on 3 generations. Est. $595M annual commissions (35% payout).',
    teamSizeNeeded: {
      goal1000: 67,
      goal3000: 200,
      goal10000: 667,
      assumptions: 'Based on $15 profit per customer at 30% wholesale rate. Entry level (5%) earns much less.',
    },
    sourceUrl: 'https://foreverliving.com/income-disclosure',
    keyGotchas: [
      'Must purchase 2 Case Credits in 2 months for 30% wholesale pricing',
      'Retail commissions range from 5-30% depending on your level',
